#!/bin/sh
SPEC="pycharm-professional.spec"
...
SOURCE_LINK=$(rpmspec -P $SPEC | grep Source0 | sed -E "s/Source0:[[:space:]]*(.*)/\1/g")
...
echo "Building SRPM..."
SRPM=$(rpmbuild -bs $SPEC --define "_sourcedir `pwd`" --define "_srcrpmdir $RESULT_DIR" | sed -E "s/Wrote: (.*)/\1/g")
